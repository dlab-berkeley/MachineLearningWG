...
# Install Chris K.'s tools package.
...
1. Try running with `trace = 1` to see more details in the stepwise process.
2. Try running with `direction = "backward"` and then `direction = "both"`. Hint: with backward you will need to change the first argument to use the full model rather than the intercept-only model.
