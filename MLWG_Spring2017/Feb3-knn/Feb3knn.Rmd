...
###5c. Improve model performance
#####1. Normalize the data
We don't want larger values to indiscriminately affect results. Let's standardize the data to a normal range so that their contributions to the decision-making process become roughly equal.  

Let's use [z-scores](http://www.statsdirect.com/help/data_preparation/transform_z_scores.htm). Let's name this scaled dataframe "B":
```{r}
B <- Boston
...
Re-split the data using this z-score transformed "B" dataframe: 
```{r}
set.seed(1)
...
- long: 18/26 correctly misclassified as long  
