...
However, for a smoothed spline GAM, least squares cannot be used to estimate the coefficients. This is instead handled by "backfitting", or updating the model as each predictor is approximated using penalized likelihood maximization.  
...
earth1 <- earth(pressure ~ ., data=data, 
                degree=2, nk=min(200, max(20, 2 * ncol(train))) + 1, 
