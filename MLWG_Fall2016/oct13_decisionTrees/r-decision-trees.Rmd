...
In MLR we are also doing binary classification.

```{r}
library(mlr)

# mlr wants the outcome to be a factor variable rather than numeric.
data$Species = as.factor(data$Species)

# Generate the task for binary classification.
# Use makeMultilabelTask if going for multi-label classifcation.
...
learners = list(makeLearner("classif.rpart", id = "rpart"))
